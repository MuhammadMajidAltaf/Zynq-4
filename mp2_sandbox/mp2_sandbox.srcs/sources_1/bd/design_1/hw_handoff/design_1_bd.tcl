...
proc create_root_design { parentCell } {
  ...
  # Create instance: my_register_0, and set properties
  set my_register_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_register:1.0 my_register_0 ]
...
CONFIG.PCW_GPIO_MIO_GPIO_ENABLE {0} CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Users/Kyle/Documents/Zynq/zybo_datasheets_docs/ZYBO_def/ZYBO_zynq_def.xml} \
...
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 {-0.082} CONFIG.PCW_UIPARAM_DDR_FREQ_MHZ {525.000000} \
...
CONFIG.PCW_USB0_RESET_IO {<Select>}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins my_register_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net my_register_0_q4 [get_bd_ports led] [get_bd_pins my_register_0/q4]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins my_register_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins my_register_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins my_register_0/enable]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_register_0/S00_AXI/S00_AXI_reg] SEG_my_register_0_S00_AXI_reg
